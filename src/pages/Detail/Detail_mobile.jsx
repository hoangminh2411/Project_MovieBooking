  ...
  return (<>
    ...
    <div className="w-screen h-screen overflow-auto" style={{ backgroundColor: 'rgb(10, 32, 41)' }}>
      ...
      <div className="relative">
        ...
        <img className="rounded-3xl w-screen h-screen" src={filmDetail.hinhAnh} alt="" />

        <div className="detailContentMobile bg-white shadow-xl pb-5 pt-10 px-5 absolute bottom-0  rounded-3xl h-auto" style={{ bottom: '0%', zIndex: '1'}}>
          <div>
