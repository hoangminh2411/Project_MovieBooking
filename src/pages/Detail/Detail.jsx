        ...
        <div className=" flex justify-between items-center px-36 ">
          <div className="flex">
            ...
            <div className="ml-3 w-1/3">
              <p className="text-white text-2xl font-bold mb-2"><span className="inline-block px-2 mr-2 rounded bg-red-500 text-white  ">C18</span>{filmDetail.tenPhim}</p>
          ...
          <div className="absolute top-0 left-2/3">
            ...
            <div className={`c100 p${Math.round(filmDetail.danhGia * 10)} big`}>
